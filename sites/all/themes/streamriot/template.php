...
function streamriot_preprocess_html(&$vars) {
  //  kpr($vars['content']);
...
function streamriot_preprocess_page(&$vars,$hook) {
  //typekit
...
function streamriot_preprocess_region(&$vars,$hook) {
  //  kpr($vars['content']);
}

function streamriot_preprocess_block(&$vars, $hook) {
  //  kpr($vars['content']);
...
function streamriot_preprocess_node(&$vars,$hook) {
  //  kpr($vars['content']);
}

function streamriot_preprocess_comment(&$vars,$hook) {
  //  kpr($vars['content']);
}

function streamriot_preprocess_field(&$vars,$hook) {
  //  kpr($vars['content']);
...
function streamriot_preprocess_maintenance_page(){
  //  kpr($vars['content']);
}
...
adds form-required
*/
function streamriot_form_element($variables) {
  $output = '';
...
*/
function streamriot_textfield($variables) {
  $element = $variables['element'];
 ...
 * @ingroup themeable
 */
function streamriot_qt_quicktabs($variables) {
  global $multistream;
 ...
 * @ingroup themeable
 */
function streamriot_qt_quicktabs_tabset($vars) {
  $variables = array(
      'attributes' => array(
 ...
 * @ingroup themeable
 */
function streamriot_file_upload_help($variables) {
 ...
 * @ingroup themeable
 */
function streamriot_image_widget($variables) {
  $element = $variables['element'];
  $output = '';
...
function streamriot_preprocess_form_element(&$vars) {
...
function streamriot_preprocess_hybridauth_widget(&$vars, $hook) {
...
*/
function streamriot_password($variables) {
  $element = $variables['element'];
  $element['#size'] = '30';
